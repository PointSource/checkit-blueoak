...
# Injects the Google client secret into the client/src/app.config.json file
sed -i "s|SET_GOOGLE_CLIENT_SECRET_HERE|$GOOGLE_CLIENT_SECRET|g" $WORKSPACE/server/config/default.json
# Injects the Google client ID into the client/src/app.config.json file
